...
public class WikiInfo {
	...
	public void getInfo(String topic) {
		...
		// makes sure that the input matches how wikipedia url's look
		...
		try {
			...
			// we're going to get all 'paragraph' items from the page
			...
			// otherwise, we've successfully navigated to the topic's page,
			// and we'll add all the text within the paragraphs to our text box
			for (Element e : pars) {
				out.setText(out.getText()+e.text()+"\n\n");
			}
		} 
